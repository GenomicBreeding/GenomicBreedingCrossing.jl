...
Population improvement, and crossing simulations library. It provides tools for defining breeding populations, performing crosses, fitting genomic prediction models, and simulating progeny with and without genome-estimated breeding values.
